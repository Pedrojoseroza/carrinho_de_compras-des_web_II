...
<template>
  <div class="product-card">
    ...
    <div class="titulo-container">
      ...
      <button class="favoritos" @click="favorito ? emit('removerFavoritos', id) : emit('addToFavoritos', id)">
        <span class="heart" :class="{ ativo: favorito }">
          ♥
        </span>
      </button>
